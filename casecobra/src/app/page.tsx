      ...
      <section>
        ...
        >
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative ms-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture your favorite memoreis with your own,{" "}
                <span className="font-semibold">one-of-one</span> phone case.
                CaseCobra allows you to protext your mwmories, not just your
                phone case.
              </p>
